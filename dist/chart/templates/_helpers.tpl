...
*/}}
{{- define "gateway-dns-operator.name" -}}
...
*/}}
{{- define "gateway-dns-operator.fullname" -}}
...
*/}}
{{- define "gateway-dns-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "gateway-dns-operator.resourceName" -}}
{{- $fullname := include "gateway-dns-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "gateway-dns-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "gateway-dns-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
